...
La société mesure la qualitée de ses projets sur les retours clients, chaque
...
A la fin de chaque projet, le post-mortem est rédigé par l'équipe au complet
...
En bref les collaborateurs sont libre de communiquer à propos de tous les types
de sujet dans le respect du travail et d'autrui. Il est à noté que l'entreprise
ne perdra pas de temps à contrôler TOUT les documents rédigés par les
collaborateurs et que ceux-ci sont à la seule responsabilitée de leur rédacteur.

Finalement **TOUT ECHANGE IMPORTANT DOIT FAIRE L'OBJET D'UNE TRACE ECRITE
ARCHIVEE EN GED, TOUT ECHANGE NE FAISANT PAS L'OBJET D'UNE TRACE ECRITE N'A
JAMAIS EXISTEE TOUT COMME LES ECHANGES AYANT UNE TRACE ECRITE NON ARCHIVEE EN
GED.**
...
Chaque projet est l'objet de deux formes de documentation :
...
- La documentation en GED qui comprend :
  ...
  - L'ensemble de la documentation lié au design
...
Toutes les connaissances de l'entreprises hors projets sont archivés en GED
et font l'objet d'une documentation adaptée.

Tous les documents de suivis liés au personnel ou à l'entreprise est aussi
...
- **Documentation en GED :**
  ...
  Certains des éléments ci-dessus seront directement gérés par l'outil. Veilliez
...
- **Documentation technique :**
  ...
  être versionné avec le projet dans un dossier prévu à cet effet. Veilliez à
...
technique complémentaire) **ne doivent contenir que des informations d'ordre
publique et non restreinte**. L'audience visée est celle de l'ingénieur
industriel lambda.
...
L'entreprise tient tout de même à faire savoir que tout utilisateurs abusant de
...
GitLab pour n'autoriser l'accès qu'aux collaborateurs lié au projet.** Cette
politique ne doit cependant pas devenir LA NORME.

Pour plus d'information concernant la politique de confidentialité de
